...
def generate_config_file(
    ...
    lines = []
    lines.append("# Valkey configuration generated by valkeylite")
    lines.append("# https://github.com/cyborginc/valkeylite")
    lines.append("")
...
def validate_config(config: dict[str, Any]) -> None:
    ...
    if config.get("daemonize") == "yes":
        raise ValkeyConfigurationError(
            "daemonize=yes is not supported by valkeylite. "
